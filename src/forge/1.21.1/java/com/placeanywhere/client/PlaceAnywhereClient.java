 ...
 */
@EventBusSubscriber(modid = PlaceAnywhereMod.MOD_ID, value = Dist.CLIENT)
public class PlaceAnywhereClient {
    ...
    public static void onRenderLevelStage(RenderLevelStageEvent event) {
        ...
        Vec3 eye = mc.player.getEyePosition(event.getPartialTick().getGameTimeDeltaPartialTick(true));
    ...
    private static void drawFreeBlockOutline(PoseStack matrices, MultiBufferSource consumers, Vec3 cam,
        ...
        for (int[] e : edges) {
            ...
            consumer.addVertex(pose, x1, y1, z1).setColor(0, 230, 255, 255).setNormal(1f, 0f, 0f);
            consumer.addVertex(pose, x2, y2, z2).setColor(0, 230, 255, 255).setNormal(1f, 0f, 0f);
        }
        matrices.popPose();
    }
}
